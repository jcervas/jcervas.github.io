...
<p class="text-intro">This page contains a partial list of all the media coverage and public intellectual conversations about New York Congressional Redistricting in 2022, when I served as <strong>Special Master</strong> for the <em>New York Supreme Court and New York Court of Appeals</em>.</p>
...
<section class="class="paragraph paragraph--type--visual-router-grid paragraph--view-mode--default Section Section--black"">
