...
- **Before every class**: one short discussion-board post, due **9:00
  a.m.**, in Canvas. Two more fall in the no-class week of **September
...
Everything else — the week-by-week schedule with all readings,
assignment details, and every policy — lives in the full syllabus:
