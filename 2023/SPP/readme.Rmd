...
pres.cnty.2016 <- data.frame(fips=leadingZeroes(pres.cnty.2016$combined_fips,5), dem2016=pres.cnty.2016$votes_dem, gop2016=pres.cnty.2016$votes_gop)
     pres.cnty.2016$total <- pres.cnty.2016$dem2016pres.cnty.2016$gop2016
     tail(pres.cnty.2016)
```
...
kent <- read.csv("https://raw.githubusercontent.com/jcervas/jcervas.github.io/main/2023/SPP/Statistical-Fallacies/data/kent2020.csv")
```
