...
- [ ] The first time a user plays the game, they should be able to set the settings. Perhaps it can pop up after closing the How to Play modal (but only after the first time.)
